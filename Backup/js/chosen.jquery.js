    ...
    (i = function() {
        ...
        return t.prototype.add_node = function(t) {
            ...
            for (e = this.parsed.length, this.parsed.push({
                    ...
                    children: 0,
                    disabled: t.disabled
                }), n = [], i = 0, r = (o = t.childNodes).length; r > i; i++) s = o[i], n.push(this.add_option(s, e, t.disabled));
            return n
        ...
        var e, s, r, o, n;
        for (s = new i, r = 0, o = (n = t.childNodes).length; o > r; r++) e = n[r], s.add_node(e);
        return s.parsed
    }, e = function() {
        function t(e, s) {
        ...
        return t.prototype.set_default_values = function() {
            ...
            var e, s, i, r, o;
            for (e = "", i = 0, r = (o = this.results_data).length; r > i; i++) e += (s = o[i]).group ? this.result_add_group(s) : this.result_add_option(s), (null != t ? t.first : void 0) && (s.selected && this.is_multiple ? this.choice_build(s) : s.selected && !this.is_multiple && this.single_set_selected_text(s.text));
            return e
        }, t.prototype.result_add_option = function(t) {
            var e, s;
            return t.search_match && this.include_option_in_results(t) ? (e = [], t.disabled || t.selected && this.is_multiple || e.push("active-result"), !t.disabled || t.selected && this.is_multiple || e.push("disabled-result"), t.selected && e.push("result-selected"), null != t.group_array_index && e.push("group-option"), "" !== t.classes && e.push(t.classes), (s = document.createElement("li")).className = e.join(" "), s.style.cssText = t.style, s.setAttribute("data-option-array-index", t.array_index), s.innerHTML = t.search_text, this.outerHTML(s)) : ""
        }, t.prototype.result_add_group = function(t) {
            var e;
            return (t.search_match || t.group_match) && t.active_options > 0 ? ((e = document.createElement("li")).className = "group-result", e.innerHTML = t.search_text, this.outerHTML(e)) : ""
        }, t.prototype.append_option = function(t) {
            return this.select_append_option(t)
            ...
            var t, e, s, i, r, o, n, h, l, c, a, _, u, d, p;
            for (this.no_results_clear(), n = 0, s = !1, e = (l = this.get_search_text()).replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), o = this.search_contains ? "" : "^", r = new RegExp(o + e, "i"), _ = new RegExp(e, "i"), t = new RegExp("^" + e + "$", "i"), u = 0, d = (p = this.results_data).length; d > u; u++)(i = p[u]).search_match = !1, h = null, this.include_option_in_results(i) && (i.group && (i.group_match = !1, i.active_options = 0), null != i.group_array_index && this.results_data[i.group_array_index] && (0 === (h = this.results_data[i.group_array_index]).active_options && h.search_match && (n += 1), h.active_options += 1), (!i.group || this.group_search) && (i.search_text = i.group ? i.label : i.html, i.search_match = this.search_string_match(i.search_text, r), i.search_match && !i.group && (n += 1), s = t.test(i.html), i.search_match ? (l.length && (c = i.search_text.search(_), a = i.search_text.substr(0, c + l.length) + "</em>" + i.search_text.substr(c + l.length), i.search_text = a.substr(0, c) + "<em>" + a.substr(c)), null != h && (h.group_match = !0)) : null != i.group_array_index && this.results_data[i.group_array_index].search_match && (i.search_match = !0)));
            return this.result_clear_highlight(), 1 > n && l.length ? (this.update_results_content(""), this.create_option && this.skip_no_results || this.no_results(l)) : (this.update_results_content(this.results_option_build()), this.winnow_results_set_highlight()), this.create_option && (1 > n || !s && this.persistent_create_option) && l.length ? this.show_create_option(l) : void 0
            ...
            for (this.selected_option_count = 0, t = 0, e = (s = this.form_field.options).length; e > t; t++) s[t].selected && (this.selected_option_count += 1);
            ...
            return null != this.options.width ? this.options.width : this.form_field.offsetWidth + "%"
        ...
        }, t.default_multiple_text = "Select Some Options", t.default_single_text = "Select an Option", t.default_no_result_text = "No results match", t.default_create_option_text = "Add Option", t
    }(), (t = jQuery).fn.extend({
        chosen: function(i) {
            return e.browser_is_supported() ? this.each(function() {
                var e, r;
                r = (e = t(this)).data("chosen"), "destroy" === i && r ? r.destroy() : r || e.data("chosen", new s(this, i))
            }) : this
        }
    }), s = function(e) {
        function s() {
        ...
        return function(t, e) {
            ...
            var e, s, i;
            return null != (e = -(null != (s = t.originalEvent) ? s.wheelDelta : void 0) || (null != (i = t.originialEvent) ? i.detail : void 0)) ? (t.preventDefault(), "DOMMouseScroll" === t.type && (e *= 40), this.search_results.scrollTop(e + this.search_results.scrollTop())) : void 0
            ...
            var s;
            return (s = t(e.target).hasClass("active-result") ? t(e.target) : t(e.target).parents(".active-result").first()).length ? (this.result_highlight = s, this.result_select(e), this.search_field.focus()) : void 0
        }, s.prototype.search_results_mouseover = function(e) {
            var s;
            return (s = t(e.target).hasClass("active-result") ? t(e.target) : t(e.target).parents(".active-result").first()) ? this.result_do_highlight(s) : void 0
            ...
            var e, s, i;
            return this.result_highlight ? (e = this.result_highlight).hasClass("create-option") ? (this.select_create_option(this.search_field.val()), this.results_hide()) : (this.result_clear_highlight(), this.is_multiple && this.max_selected_options <= this.choices_count() ? (this.form_field_jq.trigger("chosen:maxselected", {
                chosen: this
            }), !1) : (this.is_multiple ? e.removeClass("active-result") : (this.result_single_selected && (this.result_single_selected.removeClass("result-selected"), i = this.result_single_selected[0].getAttribute("data-option-array-index"), this.results_data[i].selected = !1), this.result_single_selected = e), e.addClass("result-selected"), (s = this.results_data[e[0].getAttribute("data-option-array-index")]).selected = !0, this.form_field.options[s.options_index].selected = !0, this.selected_option_count = null, this.is_multiple ? this.choice_build(s) : this.single_set_selected_text(s.text), (t.metaKey || t.ctrlKey) && this.is_multiple || this.results_hide(), this.search_field.val(""), (this.is_multiple || this.form_field.selectedIndex !== this.current_selectedIndex) && this.form_field_jq.trigger("change", {
            ...
            var s;
            return (s = t('<li class="no-results">' + this.results_none_found + ' "<span></span>"</li>')).find("span").first().html(e), this.search_results.append(s)
        }, s.prototype.show_create_option = function(e) {
            var s;
            return s = t('<li class="create-option active-result"><a href="javascript:void(0);">' + this.create_option_text + '</a>: "' + e + '"</li>'), this.search_results.append(s)
        }, s.prototype.create_option_clear = function() {
            return this.search_results.find(".create-option").remove()
        }, s.prototype.select_create_option = function(e) {
            return t.isFunction(this.create_option) ? this.create_option.call(this, e) : this.select_append_option({
                value: e,
                text: e
            })
        }, s.prototype.select_append_option = function(e) {
            var s;
            return s = t("<option />", e).attr("selected", "selected"), this.form_field_jq.append(s), this.form_field_jq.trigger("chosen:updated"), this.form_field_jq.trigger("change"), this.search_field.trigger("focus")
        }, s.prototype.no_results_clear = function() {
            return this.search_results.find(".no-results").remove()
        }, s.prototype.keydown_arrow = function() {
            var t;
            return this.results_showing && this.result_highlight ? (t = this.result_highlight.nextAll("li.active-result").first()) ? this.result_do_highlight(t) : void 0 : this.results_showing && this.create_option ? this.result_do_highlight(this.search_results.find(".create-option")) : this.results_show()
            ...
            var e, s, i, r, o, n, h, l;
            if (this.is_multiple) {
                for (0, n = 0, r = "position:absolute; left: -1000px; top: -1000px; display:none;", h = 0, l = (o = ["font-size", "font-style", "font-weight", "font-family", "line-height", "text-transform", "letter-spacing"]).length; l > h; h++) r += (i = o[h]) + ":" + this.search_field.css(i) + ";";
                return (e = t("<div />", {
                    style: r
