...
function(t) {
    ...
    t.fn.collapse = i, t.fn.collapse.Constructor = o, t.fn.collapse.noConflict = function() {
        ...
        var n = e(s),
            a = n.data("bs.collapse") ? "toggle" : t.extend({}, s.data(), {
                trigger: this
            });
        i.call(n, a)
    })
...
function(t) {
    ...
    n.VERSION = "3.3.2", n.prototype.toggle = function(o) {
        var s = t(this);
...
function(t) {
    ...
    e.VERSION = "3.3.2", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        return this.$element.trigger(a), a.isDefaultPrevented() ? void 0 : (n.removeClass("in"), t.support.transition && this.$tip.hasClass("fade") ? n.one("bsTransitionEnd", o).emulateTransitionEnd(e.TRANSITION_DURATION) : o(), this.hoverState = null, this)
...
}(jQuery), $(".btn-number").click(function(t) {
    t.preventDefault(), fieldName = $(this).attr("data-field"), type = $(this).attr("data-type");
    var e = $("input[name='" + fieldName + "']"),
        i = parseInt(e.val());
    isNaN(i) ? e.val(0) : "minus" == type ? (i > e.attr("min") && e.val(i - 1).change(), parseInt(e.val()) == e.attr("min") && $(this).attr("disabled", !0)) : "plus" == type && (i < e.attr("max") && e.val(i + 1).change(), parseInt(e.val()) == e.attr("max") && $(this).attr("disabled", !0))
